...
import 'package:game_flix_flutter/feature/games/presentation/pages/screenshots_page.dart';
...
class FavoriteItemWidget extends StatelessWidget {
  ...
  const FavoriteItemWidget({super.key, required this.game, required this.gameDetails});
