          ...
          SliverAppBar(
            ...
            actions: [
              IconButton(
                ...
                icon: _isFavorite ? const Icon(Icons.favorite, color: AppColors.orange,) : const Icon(Icons.favorite_border, color: AppColors.white,),
              ),
              IconButton(
                onPressed: () {
                      ...
                      children: [
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: CachedNetworkImageProvider(widget.gameDetails.backgroundImage ?? '', cacheKey: widget.gameDetails.backgroundImage),
                            fit: BoxFit.cover,
                            scale: 1.0,
                          ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                 Icon(Iconic.star, color: widget.game.rating! >= 4 ? AppColors.lightGreen : AppColors.orange, size: 20,),
                                Text(
                            ...
                            Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                const Icon(Iconic.chart_bar, color: AppColors.orange, size: 20,),
                                Text(
                            ...
                            Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                const Icon(Iconic.cloud, color: AppColors.orange, size: 20,),
                                Text(
